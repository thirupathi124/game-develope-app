...
// import telegram from "bootstrap-icons";
import{saterday} from "../map/Homemap";
    ...
    return(
        ...
        <div className="sunday-match">
            ...
            <div className="tabs">
                ...
                >
                <Tab className="sun-contest" label="Contest"></Tab>
                <Tab className="sun-contest" label="Leaderboard"></Tab>
                <Tab className="sun-contest" label="Winning"></Tab>
                </Tabs>            */}
            </div>
